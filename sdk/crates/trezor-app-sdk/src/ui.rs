...
pub use crate::structs::{
    Property, StrExt, StrSlice, TrezorProgressEnum, TrezorUiEnum, TrezorUiResult,
};
...
pub fn confirm_value(
    ...
    let value = TrezorUiEnum::ConfirmValue {
        ...
        br_code,
        external_menu,
        footer: footer.map(|f| (f.0.into(), f.1)),
    };
    ipc_ui_call(&value)
}

pub fn confirm_value_intro(
    title: &str,
    content: &str,
    subtitle: Option<&str>,
    verb: Option<&str>,
...
pub fn confirm_with_info<'a>(
    ...
    let value = TrezorUiEnum::ConfirmWithInfo {
        ...
        items: para.into(),
        verb: verb.into(),
        verb_info: verb_info.map(|v| v.into()),
        br_name: br_name.map(|b| b.into()),
        br_code,
    };
    ipc_ui_call(&value)
