...
# Default Tropic model configuration used by the device tests. A `model_server`
# (Tropic model) seeded with this config is started separately (see the
# ``tropic_prodtest`` fixture) and its TCP port passed to the emulator.
